$(document).ready(function () {
  ...
  "mnt3feedbacksappreciations"  
    ...
    */
    ...
    var mnt1feedbackmostfrequentlocations = $("#mnt1feedbackmostfrequentlocations").val();
...
/*
   ...
   */
    ...
    if (!month1 == "") {
        var d1_1 = [
            [1325376000000, mnt1feedbackmostfrequentlocations]
    ...
    */
    ...
    var p = $.plot($("#placeholder"), data1, {
        xaxis: {
            ...
            max: (new Date(2011, 12, 18)).getTime(),
            mode: "time",
            timeformat: "%b",
            tickSize: [1, "month"],
            monthNames: [locationname],
            tickLength: 0, // hide gridlines
            axisLabel: 'Most Frequent Locations',
