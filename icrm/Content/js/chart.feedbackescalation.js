$(document).ready(function () {
  ...
  "mnt3feedbacksappreciations"  
    ...
    */
    ...
    var mnt2feedbackescalated = $("#mnt2feedbackescalated").val();
    var mnt2feedbacksnotescalated = $("#mnt2feedbacksnotescalated").val();



    var mnt3feedbackescalated = $("#mnt3feedbackescalated").val();
    var mnt3feedbacksnotescalated = $("#mnt3feedbacksnotescalated").val();
    ...
    */
    ...
    if (!parseFloat(mnt1feedbacksall) == 0) {
        mnt1feedbackescalated = ((parseFloat(mnt1feedbackescalated) * 100) / parseFloat(mnt1feedbacksall)).toFixed(2);
        mnt1feedbacksnotescalated = ((parseFloat(mnt1feedbacksnotescalated) * 100) / parseFloat(mnt1feedbacksall)).toFixed(2);

    }


    if (!parseFloat(mnt2feedbacksall) == 0) {
        mnt2feedbackescalated = ((parseFloat(mnt2feedbackescalated) * 100) / parseFloat(mnt2feedbacksall)).toFixed(2);
        mnt2feedbacksnotescalated = ((parseFloat(mnt2feedbacksnotescalated) * 100) / parseFloat(mnt2feedbacksall)).toFixed(2);

    }

    if (!parseFloat(mnt3feedbacksall) == 0) {
        mnt3feedbackescalated = ((parseFloat(mnt3feedbackescalated) * 100) / parseFloat(mnt3feedbacksall)).toFixed(2);
        mnt3feedbacksnotescalated = ((parseFloat(mnt3feedbacksnotescalated) * 100) / parseFloat(mnt3feedbacksall)).toFixed(2);
   ...
   */
    ...
    if (!month1 == "") {
        var d1_1 = [
            [1325376000000, mnt1feedbackescalated],
            [1328054400000, mnt1feedbacksnotescalated]
    ...
    if (!month2 == "") {
        var d1_2 = [
            [1325376000000, mnt2feedbackescalated],
            [1328054400000, mnt2feedbacksnotescalated]
        ];
    }
    ...
    if (!month3 == "") {
        var d1_3 = [
            [1325376000000, mnt3feedbackescalated],
            [1328054400000, mnt3feedbacksnotescalated]
        ];
    }
    /* var d1_4 = [
         [1325376000000, 15],
    ...
    var p = $.plot($("#placeholder"), data1, {
        xaxis: {
            ...
            timeformat: "%b",
            tickSize: [1, "month"],
            monthNames: ["Escalated", "Not Escalated"],
    ...
    function getMonthName(newTimestamp) {
        ...
        var monthArray = ["Escalated", "Not Escalated"];
