$(document).ready(function () {
  ...
  "mnt3feedbacksappreciations"  
    ...
    */
    ...
    var mnt1feedbacklegitimate = $("#mnt1feedbacklegitimate").val();

    var mnt1feedbackillegitimate = $("#mnt1feedbackillegitimate").val();




    var mnt2feedbacklegitimate = $("#mnt2feedbacklegitimate").val();

    var mnt2feedbackillegitimate = $("#mnt2feedbackillegitimate").val();



    var mnt3feedbacklegitimate = $("#mnt3feedbacklegitimate").val();

    var mnt3feedbackillegitimate = $("#mnt3feedbackillegitimate").val();
    ...
    */
    ...
    if (!parseFloat(mnt1feedbacksall) == 0) {
        mnt1feedbacklegitimate = ((parseFloat(mnt1feedbacklegitimate) * 100) / parseFloat(mnt1feedbacksall)).toFixed(2);
        mnt1feedbackillegitimate = ((parseFloat(mnt1feedbackillegitimate) * 100) / parseFloat(mnt1feedbacksall)).toFixed(2);
   ...
   */
    ...
    if (!month1 == "") {
        var d1_1 = [
            [1325376000000, mnt1feedbacklegitimate],
            [1328054400000, mnt1feedbackillegitimate]
    ...
    if (!month2 == "") {
        var d1_2 = [
            [1325376000000, mnt2feedbacklegitimate],
            [1328054400000, mnt2feedbackillegitimate]
        ];
    }
    ...
    if (!month3 == "") {
        var d1_3 = [
          [1325376000000, mnt3feedbacklegitimate],
            [1328054400000, mnt3feedbackillegitimate]
        ];
    }
    /* var d1_4 = [
         [1325376000000, 15],
    ...
    var p = $.plot($("#placeholder"), data1, {
        xaxis: {
            ...
            timeformat: "%b",
            tickSize: [1, "month"],
            monthNames: ["Legitimate Claims", "Illegitimate Claims"],
            tickLength: 0, // hide gridlines
            axisLabel: 'Salary Issues Reasons',
    ...
    function getMonthName(newTimestamp) {
        ...
        var monthArray = ["Legitimate Claims", "Illegitimate Claims"];
