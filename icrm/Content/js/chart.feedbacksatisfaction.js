$(document).ready(function () {
  ...
  "mnt3feedbacksappreciations"  
    ...
    */
    ...
    var mnt1feedbacksatisfied = $("#mnt1feedbacksatisfied").val();

    var mnt1feedbacksunsatisfied = $("#mnt1feedbacksunsatisfied").val();




    var mnt2feedbacksatisfied = $("#mnt2feedbacksatisfied").val();
    var mnt2feedbacksunsatisfied = $("#mnt2feedbacksunsatisfied").val();



    var mnt3feedbacksatisfied = $("#mnt3feedbacksatisfied").val();
    var mnt3feedbacksunsatisfied = $("#mnt3feedbacksunsatisfied").val();
    ...
    */
    ...
    if (!parseFloat(mnt1feedbacksall) == 0) {
        mnt1feedbacksatisfied = ((parseFloat(mnt1feedbacksatisfied) * 100) / parseFloat(mnt1feedbacksall)).toFixed(2);
        mnt1feedbacksunsatisfied = ((parseFloat(mnt1feedbacksunsatisfied) * 100) / parseFloat(mnt1feedbacksall)).toFixed(2);

    }


    if (!parseFloat(mnt2feedbacksall) == 0) {
        mnt2feedbacksatisfied = ((parseFloat(mnt2feedbacksatisfied) * 100) / parseFloat(mnt2feedbacksall)).toFixed(2);
        mnt2feedbacksunsatisfied = ((parseFloat(mnt2feedbacksunsatisfied) * 100) / parseFloat(mnt2feedbacksall)).toFixed(2);

    }

    if (!parseFloat(mnt3feedbacksall) == 0) {
        mnt3feedbacksatisfied = ((parseFloat(mnt3feedbacksatisfied) * 100) / parseFloat(mnt3feedbacksall)).toFixed(2);
        mnt3feedbacksunsatisfied = ((parseFloat(mnt3feedbacksunsatisfied) * 100) / parseFloat(mnt3feedbacksall)).toFixed(2);
   ...
   */
    ...
    if (!month1 == "") {
        var d1_1 = [
            [1325376000000, mnt1feedbacksatisfied],
            [1328054400000, mnt1feedbacksunsatisfied]
    ...
    if (!month2 == "") {
        var d1_2 = [
            [1325376000000, mnt2feedbacksatisfied],
            [1328054400000, mnt2feedbacksunsatisfied]
        ];
    }
    ...
    if (!month3 == "") {
        var d1_3 = [
            [1325376000000, mnt3feedbacksatisfied],
            [1328054400000, mnt3feedbacksunsatisfied]
        ];
    }
    /* var d1_4 = [
         [1325376000000, 15],
    ...
    var p = $.plot($("#placeholder"), data1, {
        xaxis: {
            ...
            timeformat: "%b",
            tickSize: [1, "month"],
            monthNames: ["Satisfied", "Not Satisfied"],
            tickLength: 0, // hide gridlines
            axisLabel: 'Satisfaction',
    ...
    function getMonthName(newTimestamp) {
        ...
        var monthArray = ["Satisfied", "Not Satisfied"];
